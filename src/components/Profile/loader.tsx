    ...
    <div className="flex flex-col space-y-6 border border-gray-600 shadow rounded-md p-4 animate-pulse">
      <div className="flex  flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 justify-start">
        ...
        <div className="w-full md:w-2/3 flex flex-col space-y-2">
          ...
          <div className="w-1/3 bg-gray-800" />
          <div className="w-1/3 bg-gray-800" />
          <div className="flex flex-col flex-wrap space-y-2 md:space-x-4 md:flex-row md:justify-between">
            {/* Company */}
            <div className="w-1/4 bg-gray-400 dark:bg-white" />
            {/* Location */}
            <div className="w-1/4 bg-gray-400 dark:bg-white" />

            {/* Date Joined */}
            <div className="w-1/4 h-2 bg-gray-400 dark:bg-white" />
      ...
      <div className="flex justify-between">
        ...
        <Card className="px-10 py-4 cursor-pointer">
          ...
          <div className="mt-4 w-full bg-gray-800" />
        </Card>
        {/* Followers No */}
        <Card className="px-10 py-4 cursor-pointer">
          <div className="w-full bg-gray-800" />
        ...
        {/* Following No */}
        <Card className="px-10 py-4 flex cursor-pointer">
          <div className="w-full h-4 bg-gray-800" />
          <div className="mt-4 w-full h-4 bg-gray-800" />
        </Card>
      </div>
    </div>
  )
